document.addEventListener("DOMContentLoaded", () => {
    ...
    const facultyPool = [
        ...
        { name: "Vidhu R Vijayan", role: "NCLEX RN Passed", badge: "MSc Nursing (Orthopedic)", icon: '<i class="fa-solid fa-stethoscope"></i>', desc: "Orthopedic nursing specialist with MSc Nursing and international NCLEX RN qualification, bringing clinical depth to nursing exam preparation.", img: "assets/images/Mentors/vidhu-r-vijayan.jpg" },
        // Batch 2
        ...
        { name: "Sreelakshmi E.M", role: "Kerala PSC Rank Holder", badge: "MSc Microbiology | 2nd Rank Holder", icon: '<i class="fa-solid fa-microscope"></i>', desc: "Achieved 2nd Rank in state-level health recruitment for Microbiology specialists.", img: "assets/images/Mentors/sreelakshmi-em.jpg" },
        { name: "Arathy Surendran", role: "Kerala PSC Rank Holder", badge: "MSc Nursing (Pediatrics) – KUHS", icon: '<i class="fa-solid fa-child"></i>', desc: "A Pediatrics Nursing scholar from KUHS and a recognized Kerala PSC nursing rank holder.", img: "assets/images/Mentors/arathy-surendran.jpg" },
        // Batch 3
        { name: "Sai Kiran T C", role: "GPAT Kerala Rank Holder | Research Conclave Winner", badge: "M.Pharm Pharmaceutical Chemistry | GPAT Kerala Rank Holder", icon: '<i class="fa-solid fa-flask-vial"></i>', desc: "Senior Pharmacy Faculty with M.Pharm in Pharmaceutical Chemistry, GPAT Kerala rank holder, and winner of Pharmaceutical Research Conclave 2025.", img: "assets/images/Mentors/sai-kiran-tc.jpg" },
        ...
        { name: "Jesna Prasad", role: "German A1–B2 Qualified | Nursing Background", badge: "German B1–B2 Certified | BSc Nursing", icon: '<i class="fa-solid fa-language"></i>', desc: "A BSc Nurse with German A1-B2 proficiency, expert in guiding global migration for healthcare.", img: "assets/images/Mentors/jesna-prasad.jpg" },
        // Batch 4
        { name: "Jeethu Paul", role: "Kerala PSC Rank Holder", badge: "MSc Nursing (Pediatric)", icon: '<i class="fa-solid fa-heart-pulse"></i>', desc: "A specialized Pediatric Nurse with consistent ranking records in various Kerala PSC exams.", img: "assets/images/Mentors/jeethu-paul.jpg" },
        ...
        { name: "Revathy B C", role: "Oncology Nursing Specialist", badge: "BSc Nursing (Oncology Nursing)", icon: '<i class="fa-solid fa-ribbon"></i>', desc: "BSc Nursing graduate specializing in Oncology Nursing, bringing focused clinical expertise to cancer-care nursing preparation.", img: "assets/images/Mentors/revathy-bc.jpg" },
        // Batch 5
