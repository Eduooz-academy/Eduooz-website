document.addEventListener("DOMContentLoaded", () => {
    ...
    const facultyPool = [
        ...
        // Batch 2
        { name: "Honey Mol P.V", role: "Kerala PSC Rank Holder", badge: "MSc Molecular Biology | Distinction Holder", icon: '<i class="fa-solid fa-flask"></i>', desc: "A Molecular Biology distinction holder and proven rank holder in Kerala PSC state recruitment.", img: "assets/images/Mentors/honey-mol-pv.jpg" },
        ...
        { name: "Nayana Shaji", role: "Distinction Holder | Kerala & Central Exam Ranker", badge: "M.Pharm Pharmacology | GPAT Rank Holder", icon: '<i class="fa-solid fa-award"></i>', desc: "M.Pharm Pharmacology faculty, distinction holder, GPAT rank holder, and Kerala & Central Exam rank holder.", img: "assets/images/Mentors/nayana-shaji.jpg" }
    ];
