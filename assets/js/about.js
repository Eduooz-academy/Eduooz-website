document.addEventListener("DOMContentLoaded", () => {
    ...
    const facultyPool = [
        ...
        // Batch 2
        { name: "Honey Mol P.V", role: "Kerala PSC Rank Holder", badge: "MSc Molecular Biology | Distinction Holder", icon: '<i class="fa-solid fa-flask"></i>', desc: "A Molecular Biology distinction holder and proven rank holder in Kerala PSC state recruitment.", img: "assets/images/Mentors/honey-mol-pv.webp" },
        { name: "Sreelakshmi E.M", role: "Kerala PSC Rank Holder", badge: "MSc Microbiology | 2nd Rank Holder", icon: '<i class="fa-solid fa-microscope"></i>', desc: "Achieved 2nd Rank in state-level health recruitment for Microbiology specialists.", img: "assets/images/Mentors/sreelakshmi-em.webp" },
        { name: "Arathy Surendran", role: "Kerala PSC Rank Holder", badge: "MSc Nursing (Pediatrics) – KUHS", icon: '<i class="fa-solid fa-child"></i>', desc: "A Pediatrics Nursing scholar from KUHS and a recognized Kerala PSC nursing rank holder.", img: "assets/images/Mentors/arathy-surendran.webp" },
        // Batch 3
        { name: "Sai Kiran T C", role: "GPAT Kerala Rank Holder | Research Conclave Winner", badge: "M.Pharm Pharmaceutical Chemistry | GPAT Kerala Rank Holder", icon: '<i class="fa-solid fa-flask-vial"></i>', desc: "Senior Pharmacy Faculty with M.Pharm in Pharmaceutical Chemistry, GPAT Kerala rank holder, and winner of Pharmaceutical Research Conclave 2025.", img: "assets/images/Mentors/sai-kiran-tc.webp" },
        { name: "Dr. Manjima G.S", role: "International Scholar | MSc Pharmacology (UK)", badge: "Doctor of Pharmacy | MSc Pharmacology (UK)", icon: '<i class="fa-solid fa-graduation-cap"></i>', desc: "Awarded an International Scholarship for MSc Pharmacology in the UK after completing PharmD.", img: "assets/images/Mentors/MANJIMA.webp" },
        { name: "Jesna Prasad", role: "German A1–B2 Qualified | Nursing Background", badge: "German B1–B2 Certified | BSc Nursing", icon: '<i class="fa-solid fa-language"></i>', desc: "A BSc Nurse with German A1-B2 proficiency, expert in guiding global migration for healthcare.", img: "assets/images/Mentors/jesna-prasad.webp" },
        // Batch 4
        { name: "Jeethu Paul", role: "Kerala PSC Rank Holder", badge: "MSc Nursing (Pediatric)", icon: '<i class="fa-solid fa-heart-pulse"></i>', desc: "A specialized Pediatric Nurse with consistent ranking records in various Kerala PSC exams.", img: "assets/images/Mentors/jeethu-paul.webp" },
        { name: "Reshma R", role: "AIIMS Raipur & RRB Nursing Officer Rank Holder", badge: "MSc Nursing (Paediatrics)", icon: '<i class="fa-solid fa-baby"></i>', desc: "MSc Nursing (Paediatrics) postgraduate who cleared the AIIMS Raipur Nursing Officer exam along with RRB and DHS/DME Nursing Officer recruitments.", img: "assets/images/Mentors/RESHMA R.webp" },
        { name: "Revathy B C", role: "Oncology Nursing Specialist", badge: "BSc Nursing (Oncology Nursing)", icon: '<i class="fa-solid fa-ribbon"></i>', desc: "BSc Nursing graduate specializing in Oncology Nursing, bringing focused clinical expertise to cancer-care nursing preparation.", img: "assets/images/Mentors/revathy-bc.webp" },
        // Batch 5
        { name: "Ashna Ashok", role: "OBG Nursing Specialist", badge: "MSc Nursing (OBG)", icon: '<i class="fa-solid fa-baby-carriage"></i>', desc: "BSc and MSc Nursing graduate specializing in Obstetrics & Gynaecology (OBG), providing expert maternal and women's health nursing guidance.", img: "assets/images/Mentors/ASHNA ASHOK.webp" },
        { name: "Shine Stephen", role: "Former AIIMS Faculty | UGC NET | MHA | PGDHSR", badge: "Assistant Professor | PGIMER MSc (N) | PhD Scholar", icon: '<i class="fa-solid fa-trophy"></i>', desc: "Asst. Professor – Govt. Nursing College (on leave), former AIIMS faculty, PGIMER MSc (N) 1st rank holder & INC-WHO PhD Scholar.", img: "assets/images/Mentors/SHINE.webp" },
        { name: "Nayana Shaji", role: "Distinction Holder | Kerala & Central Exam Ranker", badge: "M.Pharm Pharmacology | GPAT Rank Holder", icon: '<i class="fa-solid fa-award"></i>', desc: "M.Pharm Pharmacology faculty, distinction holder, GPAT rank holder, and Kerala & Central Exam rank holder.", img: "assets/images/Mentors/nayana-shaji.webp" }
    ];
    ...
    document.querySelectorAll('.test-marquee-container').forEach((container, idx) => {
        ...
        // Pointer Up
        function onUp() { isDragging = false; touchAxis = null; }
